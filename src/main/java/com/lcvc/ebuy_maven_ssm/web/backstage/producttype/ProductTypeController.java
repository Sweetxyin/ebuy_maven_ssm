...
public class ProductTypeController {
	...
	//跳转到管理员管理页面
	@RequestMapping(value = "/backstage/producttype/toProduct", method = RequestMethod.GET)
	public String toProduct(HttpServletRequest request) {
		request.setAttribute("list",productTypeService.getProductList());
		return "/jsp/backstage/producttype/product.jsp";
	}
	...
	//跳转到添加产品管理页面
	@RequestMapping(value = "/backstage/producttype/toAddProduct", method = RequestMethod.GET)
	public String toAddProduct(HttpServletRequest request) {
		return "/jsp/backstage/producttype/productadd.jsp";
	}
	//执行删除产品分类操作
