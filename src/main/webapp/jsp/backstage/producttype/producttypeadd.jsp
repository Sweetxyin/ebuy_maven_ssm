    ...
    <form action="<%=basePath%>backstage/producttype/doAddProductType" method="post">
        ...
        <ul class="forminfo">
            <li><label>*产品分类名称</label><input name="name" type="text" class="dfinput"
                                             value="${requestScope.productType.name}"/><i>${requestScope.errors["name"]}</i>
            </li>
            <li><label>*图片</label>
            ...
            <li><label>*优先级</label><input name="orderNum" type="text" class="dfinput"
                                          value="${requestScope.productType.orderNum}"/><i>${requestScope.errors["orderNum"]}</i>
            </li>
            <li><label>外部链接地址</label><input name="linkUrl" type="text" class="dfinput"
                                            value="${requestScope.productType.linkUrl}"/><i>${requestScope.errors["linkUrl"]}</i>
            </li>
            <li><label>产品描述</label>
                <textarea name="intro" cols="" rows=""
                          class="textinput">${requestScope.productType.intro}</textarea><i>${requestScope.errors["intro"]}</i>
            </li>
