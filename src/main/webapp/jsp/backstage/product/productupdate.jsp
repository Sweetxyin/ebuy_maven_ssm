...
<body>
    ...
    <ul class="forminfo">
        ...
        <li><label>*产品图片</label><input id="url1" name="picUrl" type="text" class="dfinput" value="${requestScope.product.picUrl}"/>
        ...
        <li><label>*是否上架</label>
            ...
            <i></i></li>
        <li><label>*产品描述</label>
            <textarea  name="description" rows cols class="textinput" value="${requestScope.product.description}"></textarea>
            <i></i></li>
        <li><label>*产品内容</label><input name="content" type="text" class="dfinput" value="${requestScope.product.content}" /><i></i></li>

    <li><label>&nbsp;</label>

        <input name="" type="submit" class="btn" value="编辑产品"/>
